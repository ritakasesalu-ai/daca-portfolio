...
# Nädal 4: SQL Basics -- UrbanStyle'i agregatsioonid

## Mida ma tegin
- Uurisin klientide andmeid sales ja product tabelis GROUP BY, HAVING, CTE SQL päringutega
- Leidsin kliendi segmentide arvus, linnad ja protsendid
